    ...
    pdf.addPage(pw.MultiPage(
      ...
      theme: pw.ThemeData(
        defaultTextStyle: pw.TextStyle(
          ...
          fontSize: 11,
          lineSpacing: 1,
          font: pw.Font.ttf(ByteData.sublistView(ttf)),
        )
      ),
        ...
        pw.Center(
          child: pw.SizedBox(
            ...
            child: pw.Table(
              ...
              children: [
                for (var i = 0; i < nama.length; i++) pw.TableRow(children: [
...
@pragma('vm:entry-point')
@isolateManagerWorker
  Future<Uint8List> susulanPraktikumCompilePdfWorker(dynamic params) {
    final Uint8List ttf = params['ttf'];
    final Uint8List ttfBold = params['ttfBold'];
    final Uint8List ttfItalic = params['ttfItalic'];
    ...
    final String nim = params['nim'];
    final String dosen = params['dosen'];
    final String nip = params['nip'];
    final String prodi = params['prodi'];
    final String praktikum = params['praktikum'];
    final List<String> modul = List<String>.from(params['modul']);
    final String alasan = params['alasan'];
    ...
    pdf.addPage(pw.MultiPage(
        ...
        theme: pw.ThemeData(
          defaultTextStyle: pw.TextStyle(
            ...
            lineSpacing: 4,
            font: pw.Font.ttf(ByteData.sublistView(ttf)),
            fontBold: pw.Font.ttf(ByteData.sublistView(ttfBold)),
            fontItalic: pw.Font.ttf(ByteData.sublistView(ttfItalic)),
          )
        ),
        margin: pw.EdgeInsets.all(2.54.wcm),
        build: (pw.Context context) => [
          pw.Center(
            child: pw.Text( 
              'SURAT PERMOHONAN PRAKTIKUM SUSULAN',
              style: pw.TextStyle(
                fontSize: 14,
                fontWeight: pw.FontWeight.bold,
              ),
          ...
          pw.Text('Yth. Dosen Pengampu $praktikum'),
          pw.SizedBox(height: 12),
          pw.Text('Di'),
          pw.SizedBox(height: 5),
          ...
          pw.Padding(
            ...
            child: pw.Column(
                ...
                pw.Text('Dengan hormat, saya yang bertanda tangan di bawah ini :'),
                pw.SizedBox(height: 12),
                ...
                pw.Text(
                  'Dengan ini mengajukan permohonan untuk bisa mengikuti '
                  'praktikum susulan $praktikum sesuai dengan waktu yang '
                  'telah disediakan oleh Lab Dasar Teknik Elektro selaku '
                  'penyelenggara praktikum.',
                  textAlign: pw.TextAlign.justify,
                ),
                ...
                pw.Text(
                  'Adapun alasan saya tidak bisa hadir pada jadwal yang '
                  'telah ditentukan sebelumnya, dikarenakan $alasan.',
                  textAlign: pw.TextAlign.justify,
                ),
                
                pw.SizedBox(height: 12),
                           
                pw.Text('Praktikum yang hendak diikuti :'),
                  ...
                  child: pw.Table(
                    ...
                    children: [
                      for (var i = 0; i < modul.length; i++) ...[
                        if (i != 0) pw.TableRow(children: [pw.SizedBox(height: 5)]),
                        pw.TableRow(children: [
                          pw.Text('${i + 1}.'),
                          pw.Text('Modul ${modul[i]}'),
                        ])
                      ]
                    ],
                  ),
                ...
                pw.Text(
                  'Demikian permohonan saya, atas pengertian dan kesempatan '
