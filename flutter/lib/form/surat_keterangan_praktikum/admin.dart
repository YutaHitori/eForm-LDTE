                              ...
                              ListTile(
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      onPressed: isMassLoading ? null : () => c.setSelectedStatus('unchecked'), 
                                        icon: Icon(Icons.help_outline, color: isMassLoading ? null : Colors.blue), tooltip: 'mark as unchecked'
                                    ),
                                    IconButton(
                              ...
                              RefreshIndicator(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    ...
                                    final isUnchecked = (c.loadingIndicator[entry.id] ?? true) || entry.status == 'unchecked';
                                    ...
                                    return ListTile(
                                      ...
                                      trailing: Row(
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                            onPressed: isUnchecked ? null : () => c.setStatus(entry.id, 'unchecked'), 
                                              icon: Icon(Icons.help_outline, color: isUnchecked ? null : Colors.blue), tooltip: 'mark as unchecked'
                                          ),
                                          IconButton(
